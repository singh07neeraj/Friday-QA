...
import { depositTypes, limitsOrder, chooseLimit, increaseLimitUrl, howDoesItWorkUrl } from '../../utils/depositLimits';
import integratedHeader from '../../page_objects/IntegratedHeader';
import { users } from '../../common/users';

const pattern = new RegExp(`^([^0-9]{1}[0-9]*.[0-9]{2})$|^(${chooseLimit})*$`);
...
describe('Smokes suite - Deposit Limits view', () => {
  describe('Deposit Limits initial view', () => {
    ...
    it('link for how it works is correct', () => {
      depositView.howDoesItWorkLink.waitForDisplayed();
